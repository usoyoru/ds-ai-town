  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-between font-body game-background">
      ...
      <div className="w-full lg:h-screen min-h-screen relative isolate overflow-hidden lg:p-8 shadow-2xl flex flex-col justify-start">
        <h1 className="mx-auto text-2xl p-3 sm:text-4xl lg:text-6xl font-bold font-display leading-none tracking-wide game-title w-full text-left sm:text-center sm:w-auto">
          DEEPSEEK AI Town
        </h1>
        ...
        {/* </div> */}
        <footer className="justify-end bottom-0 left-0 w-full flex items-center gap-3 p-6 flex-wrap pointer-events-none">
          <div className="flex gap-4 flex-grow pointer-events-none w-full justify-center">
            {/* <FreezeButton /> */}
            {/* <MusicButton /> */}
